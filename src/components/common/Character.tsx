export default function Character({
  ...
  return (
    ...
    >
      <path
        d="M107 18.5C58.3875 38.1239 36.3421 55.5725 0.5 91L1 340.5H390V91C359.07 58.8419 335.404 42.4974 283.5 18.4999C215.321 -2.17282 178.542 -6.2725 107 18.5Z"
        fill={bgcolor}
        stroke={bgcolor}
        stroke-width="2"
      />
      ...
      <path
        d="M259.229 205C259.999 203.667 261.923 203.667 262.693 205L278.248 231.941C279.017 233.275 278.055 234.941 276.516 234.941H245.406C243.867 234.941 242.904 233.275 243.674 231.941L259.229 205Z"
        fill="white"
      />
    </svg>
  );
