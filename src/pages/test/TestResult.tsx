...
import TypePercentageBar from "@/components/test/TypePercentageBar";
    ...
    <Container>
      ...
      <Main>
        ...
        <ContentWrapper>
          ...
          <CharContent>
            INTJ 유형이란? INTJ 성격 유형을 가진 사람들은 행동에 있어 자신감
            있고 분석적이며 야심찬 경향이 있습니다. 그들은 지식 추구를 좋아하고
            매우 논리적인 경향이 있습니다. 그들은 세상의 문제를 해결하는 데
            초점을 맞춘 독립적인 사상가입니다.
          </CharContent>
          <HashTags>
